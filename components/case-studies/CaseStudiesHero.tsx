      ...
      <div className="max-w-content mx-auto w-full px-6 md:px-8 lg:px-12 pt-[108px] pb-16 md:pt-[130px] md:pb-20 lg:pt-[148px] lg:pb-24">
        <div className="max-w-[820px] mx-auto text-center">
          ...
          >
            ...
            <em className="not-italic text-[var(--bh-warm-amber)]">direction</em>
          </h1>
          ...
          <p className="font-sans text-[var(--bh-slate-text)] text-[1rem] md:text-[1.1rem] leading-[1.7]">
            Three profiles that moved from scattered potential to a single, defensible academic identity. Each one is a window into how Beacon House builds the applicant before the application.
          </p>
        </div>
      </div>
    </section>
